...
# ones.
#
# paper_docs_theme: Configures Sphinx to use our theme
...
project = 'PaperMC'
copyright = '2017, PaperMC Contributors'
author = 'PaperMC Contributors'
...
javadoc_links = {
    'https://paperdocs.emc.gs/' % release: ['com.destroystokyo.paper'],
